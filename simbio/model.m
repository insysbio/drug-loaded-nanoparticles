...
nameless.parameter.NP_L_log = addparameter(nameless_model, 'NP_L_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.NP_S_log = addparameter(nameless_model, 'NP_S_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.NP_T_log = addparameter(nameless_model, 'NP_T_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.NP_K_log = addparameter(nameless_model, 'NP_K_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.NP_U_log = addparameter(nameless_model, 'NP_U_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.NP_P_log = addparameter(nameless_model, 'NP_P_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
...
nameless.parameter.D_L_log = addparameter(nameless_model, 'D_L_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_S_log = addparameter(nameless_model, 'D_S_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_T_log = addparameter(nameless_model, 'D_T_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_K_log = addparameter(nameless_model, 'D_K_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_U_log = addparameter(nameless_model, 'D_U_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_P_log = addparameter(nameless_model, 'D_P_log', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
nameless.parameter.D_P_log_free = addparameter(nameless_model, 'D_P_log_free', 'ConstantValue', false, 'ValueUnits', 'dimensionless', 'Notes', '', 'Tag', '');
...
addrule(nameless_model, 'NP_L_log = log(NP_L_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'NP_S_log = log(NP_S_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'NP_T_log = log(NP_T_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'NP_K_log = log(NP_K_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'NP_U_log = log(NP_U_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'NP_P_log = log(NP_P + conczero)', 'repeatedAssignment');
...
addrule(nameless_model, 'D_L_log = log(D_L_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_S_log = log(D_S_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_T_log = log(D_T_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_K_log = log(D_K_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_U_log = log(D_U_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_P_log = log(D_P_aver + conczero)', 'repeatedAssignment');
addrule(nameless_model, 'D_P_log_free = log(D_P + conczero)', 'repeatedAssignment');
